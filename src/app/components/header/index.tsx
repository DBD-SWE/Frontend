...
const Header = () => {
  return (
    <header className="fixed left-0 right-0 top-0 z-10 flex w-full flex-row items-center justify-between border-b-[1px] border-gray-100 bg-white px-7 py-3 lg:z-50">
      <Link href="/">
        <Image
