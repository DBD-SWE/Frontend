  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="flex w-0 cursor-text rounded border-[1px] border-white px-5 max-md:focus:px-3 py-2 text-sm text-black shadow-sm outline-none transition-all duration-250 ease-in-out placeholder:text-gray-500 hover:border-gray-400 focus:border-black max-md:focus:w-44 md:w-60 md:px-3 md:pl-10 md:focus:w-72"
      />
      <div
