...
const SearchInput = () => {
  ...
  return (
    <div className="relative">
      <div className="pointer-events-none absolute top-1/2 ml-0 flex-shrink-0 -translate-y-1/2 text-2xl max-md:right-[12px] max-md:focus:left-0  md:ml-4 [&_svg]:h-5 [&_svg]:w-5 [&_svg]:text-gray-500">
        <SearchIcon />
      </div>
